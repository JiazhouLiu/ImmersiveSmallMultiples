...
public class SteamVR_TrackedControllerForStartScene: MonoBehaviour
{
    ...
    private CubeSelectionScript css;

    // Use this for initialization
    protected virtual void Start()
    {
        em = GameObject.Find("ExperimentManager").GetComponent<ExperimentManager>();
        css = GameObject.Find("ExperimentManager").GetComponent<CubeSelectionScript>();
    ...
    public virtual void OnTriggerClicked(ClickedEventArgs e)
    {
        ...
        //em.ChangeState(gameObject, "trigger");
        //if (this.name == "Controller (left)")
        //{
        //    css.leftControllerStartPressingPosition = transform.GetChild(0).Find("tip").GetChild(0).GetChild(0).GetChild(0).position;
        //    css.currentLeftCube = css.CreateCube();
        //}
        //else {
        //    css.rightControllerStartPressingPosition = transform.GetChild(0).Find("tip").GetChild(0).GetChild(0).GetChild(0).position;
        //    css.currentRightCube = css.CreateCube();
        //}
    ...
    public virtual void OnTriggerUnclicked(ClickedEventArgs e)
    {
        ...
        //if (this.name == "Controller (left)") {
        //    css.leftControllerStartPressingPosition = Vector3.zero;
        //    css.currentLeftCube = null;
        //}
        //else{
        //    css.rightControllerStartPressingPosition = Vector3.zero;
        //    css.currentRightCube = null;
        //}
    ...
    public virtual void OnMenuClicked(ClickedEventArgs e)
    {
        ...
        //em.ChangeState(gameObject, "menu");
    }
    ...
    public virtual void OnPadClicked(ClickedEventArgs e)
    {
        ...
        //em.ChangeState(gameObject, "TouchPad");
    }
    ...
    public virtual void OnGripped(ClickedEventArgs e)
    {
        ...
        //em.ChangeState(gameObject, "grip");
    }
